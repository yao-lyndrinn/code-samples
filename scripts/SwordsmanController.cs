...
public class SwordsmanController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 10; i++){
            if(GlobalVars.obtainedVit[i]){
                maxHealth+=1;
            }
            if(GlobalVars.obtainedMana[i]){
                maxMana+=5;
            }
        }
        ...
        obtainedDash = GlobalVars.obtainedDash;
        obtainedCast = GlobalVars.obtainedCast;
        obtainedIceSpell = GlobalVars.obtainedIceSpell;
        obtainedWindSpell = GlobalVars.obtainedWindSpell;
        obtainedPickaxe = GlobalVars.obtainedPickaxe;
    }
